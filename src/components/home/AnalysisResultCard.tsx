    ...
    <Card className="backdrop-blur-sm bg-card/80">
      ...
      <CardContent className="space-y-4">
        <div className="grid grid-cols-2 gap-4">
          <div>
            <p className="text-sm text-muted-foreground">감정</p>
            <p className="text-2xl font-bold">{analysis.emotionLabel}</p>
          </div>
          <div>
            <p className="text-sm text-muted-foreground">감정 점수</p>
            <p className="text-2xl font-bold">{analysis.emotionScore}점</p>
          </div>
        </div>
        <div>
          <p className="text-sm text-muted-foreground mb-2">한 줄 요약</p>
